> This library has been integrated into the high-performance simulator [SAPIEN](https://github.com/haosulab/SAPIEN.git) 2.0. Check branch sapien for more details.
