...
> This library is integrated into [SAPIEN](https://github.com/haosulab/SAPIEN.git). SAPIEN is a state-of-the-art interactive simulation environment. Powered with SimSense and high-speed ray tracing engine, SAPIEN can simulate realistic depth in real time. Check this [tutorial](https://sapien.ucsd.edu/docs/latest/tutorial/rendering/depth_sensor.html) for more details.
