> This library has been integrated into [SAPIEN](https://github.com/haosulab/SAPIEN.git). SAPIEN is a high-performance interactive simulation environment. Powered with SimSense and [Kuafu](https://github.com/jetd1/kuafu.git), SAPIEN can simulate activestereo depth sensor in real time. Check branch `sapien` for more details.
